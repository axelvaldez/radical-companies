...
<h1>FIAT? What&rsquo;s That?</h1>
 <p>We don&rsquo;t have a label for the system we live in, so we called it , <span class="_quotespan">Because I say so,</span> with an implied threat, <span class="_quotespan">or else</span>,</p>
  <div class="_center">
   <img
