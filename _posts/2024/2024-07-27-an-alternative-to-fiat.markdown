...
<h1>RADs</h1>
 <p>RADs can make this work in the 21<sup>th</sup> century. They are tokens that can factor anything through them; they indicate a percentage. If you have twice as many RADs as me, you get twice as much (<em>e.g.</em>, money) as me.</p>
 ...
 <p>With a (<a href="https://apps.apple.com/us/app/rads/id6447589527" target="_blank">RADs! mobile app</a>) app, we can recognize contributions and give people RADs anywhere in the wold. Most importantly, such an app allowa to connect with one another and skip the boss altogether.</p>