---
layout:   post
title:    "How Radical Has Evolved"
subtitle: "TEMPLATE"
authors:  "Matt Perez, Adrian Perez, Jose Leal"
image:    "icon-how-radica-has-evolved.svg"
---

<div style='display:none; '>
 Something wanted to come out of us. Why did I make so much more money from the sale of the company than others? Everybody in the company contributed to its growh.&mdash; Traditional answers sounded hollow.
</div>
...
<h1>The <em>RADs!</em> Mobile App</h1>
 <p>The <em>RADs!</em> mobile app continues to evolve. We have added a lot of things, taken off other things, and resolved a whole lot of issues.</p>
 <p>For example, we tried to let co-owners give RADs directly, but that did work so well. So we switched to recognizing contributions. The result is converted to RADs and made tangible.</p>

<h1>No Dogma</h1>
 <p>There is nothing dogmatic here. we visualize Radical as an alternative to Fiat.</p>
 <p>You are welcome to add things and change things. Just be careful not toend up back into Fiat mode. If you do, there is no shame in course-correcting and do it better the next time.</p>
