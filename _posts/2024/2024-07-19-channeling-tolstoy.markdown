...
<h1>Slavery</h1>
 ...
 <p>This is unfortunately true <em style="color:red; ">to this day</em>. The word &lsquo;slavery&rsquo; is hard to write, but we must recognize that the Fiat system is based on it.</p>
 <div class="_citation">
