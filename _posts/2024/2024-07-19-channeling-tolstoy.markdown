...
<h1>Pacifist Lyof Nikolayevich</h1>
 ...
 <p>In <em>Confession</em> and <em>My Religion</em> he pretty much said that he was a follower of (the apocryphal) Jesus.</p>
 <div class="_citation">
...
<h1>Fiat Religions</h1>
 ...
 <p>The Internet and the Large Language Models say that Tolstoy declared himself a Christian, but is a lazy way of characterizing it. You can read the <em>Confession</em> and <em>My Religion</em> books to verify it.</p>
 <p>He did come up with his own &lsquo;believe system&rsquo; based upon the teachings of Jesus, as per the Christian Bible, while rejecting the institutional church dogmas (orthodox, catholic, protestant, etc).</p>
...
<h1>Tranquilizing Explanations</h1>
 ...
 <p>These are presented as &ldquo;<em>unalterable laws governing man&rsquo;s economic activities</em>.&rdquo; He also called them &ldquo;tranquilizing scientific explanations,&rdquo;</p>
 <div class="_citation">
...
<h1>Businesses Are Unecessary</h1>
 <div class="_citation">
  <p>&ldquo;<em>&hellip; if once upon a time [a business as it is today] was necessary, it is now absolutely unnecessary, &hellip; harmful, and dangerous.</em>&rdquo; &hellip; <em>because the effect of this organization on all the evil that exists in society is not to lessen and correct, but rather to</em> strengthen and comfirm <em>that evil</em>.</p>
  <p id="_signature">Leo Tolstoy, <em>The Slavery of Our Times</em></p>
 </div>
