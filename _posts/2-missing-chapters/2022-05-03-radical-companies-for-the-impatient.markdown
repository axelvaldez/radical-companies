...
<h1>The Radical Distribution</h1>
 <p>Instead of cash or stocks, <span class="_paradigm">Radical Distribution</span> uses a dimensionless unit we call a <span class="_paradigm">RAD</span>,</p>
  <ul>
   ...
   <l>Whereas stocks represent a fixed percentage of the company <em>forever</em>, <span class="_paradigm">RAD</span>s represent a dynamic <em>percentage</em> of ownership<em> at each cycle</em>.</li>
  </ul>
