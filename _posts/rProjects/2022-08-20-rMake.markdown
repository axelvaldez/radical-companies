...
<h1>Then Came <span style="font-size:smaller; ">rMAKE</span>!</h1>
 <p>In the end, we opted to create a new app we call <span style="font-size:smaller; ">rMAKE</span> as an OSS platform that others can extend. There are several OSS editors that we can leverage for our UI. Also, there are many OSS components and libraries that we can use in the making of <span style="font-size:smaller; ">rMAKE</span> (<em>e.g.</em>, diff).<a href="#en05"><sup id="bm05">5&nbsp;</sup></a></p>
 <h2>No Trunk</h2>
...
<h1>Publishing</h1>
 ...
 <p>See <a href="#">rMEDIA</a><a href="#en07"><sup id="bm07">7&nbsp;</sup></a> for more info.</p>
...
<h1>Roles</h1>
 ...
 <h2>Co-Writers</h2>
  ...
  <ul>
   ...
   <li>Fork a particular fragment, be it a section or subsection, a paragraph, a sentence, phrase, or excursus.<a href="#en08"><sup id="bm08">8&nbsp;</sup></a></li>
   <li>
    <p style="margin-bottom:0; ">Create a Pull Request<a href="#en09"><sup id="bm09">9&nbsp;</sup></a> to,</p>
    <ol>
...
<h1>References</h1>
 <p>An <span style="font-size:smaller; ">rMAKE</span> reference can include text, URLs, or both, a la Kindle.</p>
 <p>URLs can point to internal targets (<em>e.g.</em>, titles, headers).</p>

<h1>Paper</h1>
 <p>The <span style="font-size:smaller; ">rMAKE</span> platform can prepare a flow for traditional paper publication. In particular, the platform will make it easy to convert references and URLs to footnotes or endnotes.</p>
 ...
 <ol>
  ...
  <li id="en06">
   <p class="_list-item">
    ...
    <<a href="https://www.google.com/search?q=excursus&oq=excursus" target="_blank">excursus</a>>
  ...
  <li id="en07">
   <p class="_list-item">
    ...
    <<a href="https://en.wikipedia.org/wiki/Fork_and_pull_model" target="_blank">Pull Request</a>>
