...
<h1>Publishing</h1>
 ...
 <p>See rMEDIA<a href="#en09"><sup id="bm09">9&nbsp;</sup></a> for more info.</p>
...
<h1>Roles</h1>
 ...
 <h2>Co-Writers</h2>
  ...
  <ul>
   ...
   <li>Fork a particular fragment, be it a section or subsection, a paragraph, a sentence, phrase, or excursus.<a href="#en11"><sup id="bm11">11&nbsp;</sup></a></li>
   <li>
...
<h1 class="_section">ENDNOTES</h1>
 <div>
  <ol>
   ...
   <!--
    id="en10" is below, in the RELATED section
   -->
   <li id="en11" style="counter-increment:muffin 2;">
    <p class="_list-item">
  ...
  <li>Blog posts,</li>
   ...
   <li>rCompanies</li>
    <ul>
     <li rMEDIA,
      <ul>
       <li>rShelf: <a href="https://radicalcompanies.com/2022/04/02/rShelf" target="_blank">&hellip;/rShelf</a></li>
       <li>rReader: <a href="https://radicalcompanies.com/2022/04/01/rReader" target="_blank">&hellip;/rReader</a></li>
       <li>RADICALS.LIVE!: <a href="https://radicalcompanies.com/2022/04/04/rLive" target="_blank">&hellip;/rLive</a></li>
       <li>rMBA: <a href="https://radicalcompanies.com/2022/04/03/rMBA" target="_blank">&hellip;/rMBA</a></li>
      </ul>
