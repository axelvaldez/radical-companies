 ...
 <h2>Git</h2>
  <table>
   <tr>
    ...
    <td>
     <ul>
      <li>Git is a very popular software source control<a href="#en04"><sump id="bm04">4&nbsp;</sup></a> system. It allows software developers to work as peers, in parallel.</li>
 ...
 <ol style="text-align:left; ">
  ...
  <li id="en06">
   <p class="_list-item">
    ...
    <a class="_uparrow" href="#6"><img src="/assets/img/arrow-up-icon.png"></a>
   </p>
  </li>
  <li id="en07">
   <p class="_list-item">
  ...
  <!--
   id="en09" is below, in the RELATED section
  -->
  <li id="en10">
   <p class="_list-item">
