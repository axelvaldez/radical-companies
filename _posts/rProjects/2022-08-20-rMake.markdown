...
<div style="font-size:25px; border:1px solid CadetBlue; background-color:beige; font-family:American Typewriter, serif; white-space:normal; padding:1em; margin-bottom:20px; ">
 ...
 <p style="text-align:right; padding-right:1em; margin-top:15px; ">&mdash;Marysol Ortega, PhD</p><a href="#en01"><sup id="bm01">1&nbsp;</sup></a>
</div>
 ...
 <h2>MediaWiki</h2>
  <table>
   <tr>
    ...
    <td>
     <ul>
      <li>This is the wiki engine used by Wikipedia and it is friendly enough for writers. At least those who are used to Wiki Markup.<a href="#en04"><sup id="bm04">4&nbsp;</sup></a></li>
      ...
      <li>It has pretty good documentation for developers.<a href="#en05"><sup id="bm05">5&nbsp;</sup></a></li>
     </ul>
    </td>
   </tr>
  </table>
...
<h1>Then Came <span style="font-size:smaller; ">rMAKE</span>!</h1>
 <p>In the end, we opted to create a new app we call <span style="font-size:smaller; ">rMAKE</span><a href="#en06"><sup id="bm06">6&nbsp;</sup></a> as an OSS platform that others can extend. There are several OSS editors that we can leverage for our UI. Also, there are many OSS components and libraries that we can use in the making of <span style="font-size:smaller; ">rMAKE</span> (<em>e.g.</em>, diff).</p>
 <h2>No Trunk</h2>
...
<h1>Publishing</h1>
 ...
 <p>See <a href="#">rMEDIA</a><a href="#en08"><sup id="bm08">8&nbsp;</sup></a> for more info.</p>
...
<h1>Roles</h1>
 ...
 <h2>Co-Writers</h2>
  ...
  <ul>
   ...
   <li>Fork a particular fragment, be it a section or subsection, a paragraph, a sentence, phrase, or excursus.<a href="#en09"><sup id="bm09">9&nbsp;</sup></a></li>
   <li>
    <p style="margin-bottom:0; ">Create a Pull Request<a href="#en10"><sup id="bm10">10&nbsp;</sup></a> to,</p>
    <ol>
...
https://www.amazon.com/How-Lie-Statistics-Darrell-Huff/dp/0393310728/ref=pd_lpo_sbs_14_img_1?_encoding=UTF8&psc=1&refRID=FKW6Y0VTHKGY7C3EM3YD
  <li id="en04">
   <p class="_list-item">
