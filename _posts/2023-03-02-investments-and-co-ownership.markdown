...
<h1>Reminders</h1>
 <ul>
  ...
  <li>For internal investments, the &ldquo;consent&rdquo; <span class="_paradigm">RAD</span>s get taken out of the <span class="_paradigm">RAD</span>s given in this cycle and contributed to the <span class="_paradigm">BANNER</span>s. The &ldquo;consent&rdquo; <span class="_paradigm">RAD</span>s get equal ownerships.</li>
 </ul>
