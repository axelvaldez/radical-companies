...
<h1><SPAN STYLE="font-size:smaller; ">rCOIN</SPAN> Qualities</h1>
 ...
 <h3>Decentralized Minting of <span class="_paradigm">rCOIN</SPAN>s</h3>
  ...
  <p style="font-family: courier new; text-align: center; width: 75%; border: silver dotted 1px; margin: auto; margin-bottom: 20px; ">
   <img src="/assets/img/pic-decentralized-minting-en.svg" alt="A company gets REVENUE, at the top, and sends COINs out to the world, at the bottom. In parallel, a company mints its own COINs, as needed, and they go out to the world mixed in with REVENUE COINs." title="Decentralizd Minting" style="align: center; "></p>
