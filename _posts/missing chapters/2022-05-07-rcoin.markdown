  ...
  <table align="center">
   ...
   <tbody style="font-size:smaller; ">
    <tr style="vertical-align:text-top; ">
     ...
     <td style="text-align:center; background-color:lightgrey; ">Meaning & Belonging</td>
    </tr>
    <tr>
    ...
    <tr style="vertical-align:text-top; ">
     ...
     <td style="text-align:center; background-color:lightgrey;">Transparency & Decentralization</td>
    </tr>
    <tr>
     <td style="font-size:7px; ">&nbsp;</td>
    </tr>
    <tr style="vertical-align:text-top; ">
     <th style="text-align:right; padding-right:1ex; ">practices</th>
     <td style="text-align:center; background-color:lightgrey; ">Experimentation</td>
    </tr>
    <tr>
     <td colspan="4">&nbsp;</td>
    </tr>
