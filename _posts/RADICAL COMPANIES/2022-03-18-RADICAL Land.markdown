...
<div STYLE="background-color:#FFFAF0; padding:1em; border:1px solid CadetBlue; "> <!-- Opening Quotes -->
...
<h1>Introduction</h1>
 <p style="text-align: justify; ">In the book <span style="font-size:smaller; "><a href="https://radicalscompanies.com">RADICAL COMPANIES</a></span>, we only considered how the <span style="font-size: smaller; ">RADICAL</span> model would work in <em>a company environment</em>, and other than a mention, we said nothing about money, land, or governments.</p>
 ...
 <h2 style="text-align: center;">ENDNOTES</h2>
  <div class="endnotes">
   <ol>
    ...
    <li id="fn4">
     <h6>
      <a href="#fnref4">back</a>&nbsp;I must admit that this aspect of the RADICAL model would be a pushover for outer space FIAT invaders.
     </h6>
    </li>
   </ol>
  </div>
