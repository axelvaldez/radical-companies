...
<<pre class="prettyprint" style="font-size: 30px; text-align: center; border: 1px solid CadetBlue; background-color: #FFFAF0; font-family: American Typewriter, serif; "><span style="text-align: right; ">&mdash; Abraham Lincoln&rdquo;<sup id="fnref1"><a href="#fn1" rel="footnote">1</a></sup></span>
</pre>
...
<table>
  <tr>
   <td>
    ...
    <p style="text-align: right; font-size: smaller; text-align: justify; "><em>— Yours Truly, Fay Lewis</em><sup id="fnref2"><a href="#fn2">2</a></sup>
    </p>
   </td>
  </tr>
  <tr><td>&nbsp;</td></tr>
</table>
<p style="text-align: justify; ">The bidding system might look something like this,
</p>
<ul>
...
<p style="text-align: justify; ">A couple of unpolished thoughts,
</p>
<ul>
...
<h2>Terminology</h2>
 ...
 <p style="text-align: justify; ">If the current occupier wins, then everything continues as before. However, if somebody has a higher bid, the new occupier moves in. If the new occupier wants to do away with an improvement, she pays for doing so.
 </p>
