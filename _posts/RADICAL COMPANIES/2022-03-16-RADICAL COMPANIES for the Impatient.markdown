...
<h1 style="text-align: center; font-size:7ex; margin:40px 0 20px 0; ">Strictly for the Impatient</h1>
 ...
 <pre id="fnref1" class="prettyprint" style="font-size:40px; text-align:center; border:1px solid CadetBlue; background-color:#FFFAF0; font-family:American Typewriter, serif; white-space:normal; margin:30px 0; ">
