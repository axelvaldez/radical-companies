...
<h1 style="text-align: center; font-size:7ex; margin:40px 0 20px 0; ">Strictly for the Impatient</h1>
 ...
 <h2>Easy-to-Remember Foundation for a <span style="font-size:smaller; ">RADICAL</span> Companyß</h2>
 ...
 <pre class="prettyprint" style="font-size:60px; text-align:center; border:1px solid CadetBlue; background-color:#FFFAF0; font-family:American Typewriter, serif; white-space:normal; margin:30px 0; ">
  <p style="font-size: smaller; padding: 0 3em; ">“An x organism constantly changes. The cells develop, die and are replaced. It adapts to the current environment or goes away. … The org chart is insufficient.”<sup id="fnref1"><a href="#fn1" rel="footnote">1</a></sup></p>
 </pre>
...
<p>The Distribution mechanism we describe below makes ownership decentralized and dynamic. It supports egalitarian and equitable wealth sharing based on contribution. And it is scalable.</p>
 ...
 <h2>The <SPAN STYLE="FONT-SIZE: SMALLER; ">RADICAL</SPAN> Distribution Difference</h2>
  ...
  <h3><span style="font-size:smaller; ">RADICAL</span> Distribution Is Transparency</h3>
