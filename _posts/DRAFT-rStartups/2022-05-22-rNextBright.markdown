...
<h1 style="font-size:40px; font-family:Courier New, monospace; margin-top:40px; ">Programs for Employers</h1>
 ...
 <ul>
  ...
  <li>Traditional Sourcing – Hire graduates for a fee. They can hire graduates “by the drink” at $<code>X</code>/hire. (?)</li>
  <li>Pre-Sourcing – Hire graduates for $<code>Y</code>/hire (where $<code>Y</code> &lt; $<code>X</code>) by prepaying for <code>N</code> hires. Requires an in-depth Kickoff.</li>
