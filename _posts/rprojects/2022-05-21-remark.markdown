...
<h1>Intro</h1>
 <div>
  <img
   ...
   style="float:left; padding-top:25px; padding-right:10px; "
 ...
 <p><em>rEmark!</em> is represented by floating buttons that readers can use to give feedback to authors. Clicking on the <code>plus</code> button records a positive response to specific text that readers highlight; the <code>minus</code> button indicates some form of dissatisfaction with a highlighted segment.</p>
