...
<h1>Intro</h1>
 ...
 <p>Readers can leave comments for each fragment they click on. Other visitors to the site can choose to see all comments ("comments ON") or not ("comments OFF"), default).</p>
