...
<div class="_citation">
 ...
 <p id="_signature">Dr Marysol Ortega<a href="#en01"><sup id="bm01">&nabla;&hairsp;</sup></a></p>
</div>
...
<h1>But You Already Can, Can&rsquo;t You?</h1>
 <p>My first thought was that any of the various <em>Git</em><a href="#en02"><sup id="bm02">&nabla;&hairsp;</sup></a> platforms, MediaWiki,<a href="#en03"><sup id="bm03">&nabla;&hairsp;</sup></a> or even Google Docs could be it.</p>
 <div class="_center">
  <table class="_explicitalignment">
   ...
   <tr>
    ...
    <td>
     <ul>
      <li><em>Git</em> is a very popular software source control<a href="#en04"><sup id="bm04">&nabla;&hairsp;</sup></a> system. It allows software developers to work as peers, in parallel.</li>
   ...
   <tr>
    ...
    <td>
     <ul>
      <li>This is the wiki engine used by Wikipedia and it is friendly enough for writers. At least those who are used to Wiki Markup.<a href="#en05"><sup id="bm05">&nabla;&hairsp;</sup></a></li>
      ...
      <li>It has pretty good documentation for developers.<a href="#en06"><sup id="bm06">&nabla;&hairsp;</sup></a></li>
     </ul>
    </td>
   </tr>
   <tr>
...
<h1><span class="_paradigm">rMAKE</span> Is Born</h1>
 <p>In the end, we opted to create a new app we call <span class="_paradigm">rMAKE</span><a href="#en07"><sup id="bm07">&nabla;&hairsp;</sup></a> as an OSS platform that others can extend. There are several OSS editors that we can leverage for our UI and many OSS components and libraries that we can use in the making of <span class="_paradigm">rMAKE</span> (<em>e.g.</em>, diff).</p>
    ...
    <td>
     <p style="margin-bottom:0; ">Same as a single writer, but in addition they need to,</p>
      <ul>
       ...
       <li>Fork a particular fragment, be it a section or subsection, a paragraph, a sentence, phrase, or excursus.<a href="#en10"><sup id="bm10">&nabla;&hairsp;</sup></a></li>
       <li>
        <p style="margin-bottom:0; ">Create a Pull Request<a href="#en11"><sup id="bm11">&nabla;&hairsp;</sup></a> to,</p>
         <ol>
