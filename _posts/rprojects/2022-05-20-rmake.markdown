...
<h1>Why <span class="_paradigm">rMAKE</span></h1>
 ...
 <p>The intent of <span class="_paradigm">rMAKE</span> is to make it possible for many people to contribute to a book and get authorship and ownership consistently. What would have been a laborious process for books written with a quill pen or a typewriter, it is a piece of cake using basic modern technology.</p>
