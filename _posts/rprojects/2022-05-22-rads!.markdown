...
<h1>BREAKING</h1>
 <p>BBB There is now a very basic version of the app in the IOS store and the Android store.</p>
  <div class="_center">
   <table style="border:1px solid black; ">
    ...
    <tr>
     <td>
      <a href="https://apps.apple.com/mx/app/rads/id6447589527?l=en"><img src="/assets/img/pic-apple-download-button.svg" width="70%" alt="The Apple store pseudo button"></a>
     </td>
     <td>
      <a href="#"                                                   ><img src="/assets/img/pic-android-download-button.svg" width="70%" alt="The Android store pseudo button"></a>
     </td>
    </tr>
   </table>
  </div>
