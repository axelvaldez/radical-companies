...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Alignment</h1>
 ...
 <tbody style="font-size:smaller; vertical-align:top; ">
  <tr>
   <td colspan="2" style="font-weight:bold; font-size:larger; text-align:right; border:2px solid green; ">Impact</td>
  </tr>
  <tr>
  ...
  <tr>
   <td colspan="2" style="font-weight:bold; font-size:larger; text-align:right;  border:2px solid green;">Purpose</td>
  </tr>
  <tr>
