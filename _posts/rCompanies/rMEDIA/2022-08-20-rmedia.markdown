...
<h1>Intro</h1>
 ...
 <p>As MoTown was to Black artists and their music, rMedia is to RADICAL authors and themes.</p>
<h1>Origin Story</h1>
 ...
 <table>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>Create a source of information about the RADICAL.
     <li> rMedia becomes the MoTown  of RADICAL content.
     </li>
    </ul>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>We want the world to recognize the FIAT conditions they live in.</li>
     <li>Give people a choice to move away from FIAT and towards a RADICAL world.</li>
     <li>To spread RADICAL-like ideas sooner, faster, and without debilitating compromises.</li>
    </ul>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td>
    <ul>
     ...
     <li>Organized as a RADICAL company.  Everybody who contributes (<em>e.g.</em>, authors, distributors, printers) participates in its ownership and the wealth it generates.</li>
    </ul>
   </td>
  </tr>
  <tr>
 ...
 <table>
  <tr>
   ...
   <td>
    <ul>
     ...
     <li>Being a rMedia author (<em>i.e.</em>, progressive, future positive).</li>
  ...
  <tr>
   <td>
    <p style="text-align: right">Content Editors, Layout Designers, Developers, Graphics Designers, Media Team, Producers</p>
   </td>
   <td>
    <ul>
     <li>Doing what they love, without paying the FIAT price.<li>
  ...
  <tr>
   <td>
    <p style="text-align: right">Translators, Verifiers</p>
   </td>
   <td>
<ul>

<li>Learn what is perceived as a contribution.

<li>Champion your own notion of what represents a contribution from a translator or a verifier.
</li>
</ul>
   </td>
  </tr>
...
<li>Learning from the ability to experiment with various media, different messages.

<li>Spreading the RADICAL story, their story.

<li>Experimenting with different ways of getting the message out.
</li>
</ul>
   </td>
  </tr>
...
<li>Learning from listening to different types of buyers.

<li>Learning what it takes to turn them into evangelists, not just book sellers.
...
<li>Learning to take the friction out of printing books.

<li>They’ll hear, “we’ll help you compete with Amazon.”
</li>
</ul>
   </td>
  </tr>
...
<li>Learning to take the friction out of book distribution.
...
<li>Learning to become impassionate evangelists, not just book sellers.
...
<li>Be associated with a  unique, easily identifiable brand that belongs to all who contribute.

<li>They’ll have to win rMedia‘s endorsement the FIAT way. Unless they flip to the RADICAL paradigm.
</li>
</ul>
   </td>
  </tr>
...
<strong><code>rMedia</code></strong></p>
</h3>
...
<li>A much needed service centered on people to spread healing ideas, create content, and distribute it all far, wide. and fast.

<li>rMedia becomes a unique, easily recognized brand.
</li>
</ul>
   </td>
  </tr>
...
<li>Teach new authors about the process. Point out that it will take lots of reviewing over and over.

<li>Profile the authors to co-figure out how much of the work below they are willing/capable to do.

<li>Training in the use of new tools (<em>e.g.</em>, InDesign, Jutoh, PRADERA MAKE).

<li>Mentoring (<em>i.e.</em>, tools to find  an experienced author).
</li>
</ul>
   </td>
  </tr>
...
<li>With an experienced editor from anywhere in the world.
</li>
</ul>
   </td>
  </tr>
...
<li>With copy editors from anywhere in the world.
</li>
</ul>
   </td>
  </tr>
...
<li>With designers from anywhere in the world.
</li>
</ul>
   </td>
  </tr>
...
<li>With layout book designers  from anywhere in the world.
</li>
</ul>
   </td>
  </tr>
...
<li>With skilled people from anywhere in the world.
</li>
</ul>
   </td>
  </tr>
...
<li>Acquisition and assignment of ISBN numbers.
</li>
</ul>
   </td>
  </tr>
...
<li>With translators from anywhere in the world.
</li>
</ul>
   </td>
  </tr>
...
<li>Provides the equivalent of an “advance” for co-authors who need the support upfront.

<li>Used to test the effectiveness of different types of promotions, descriptions, tags, etc.
</li>
</ul>
   </td>
  </tr>
  ...
  <tr>
   <td>
    <p style="text-align: right">RADICAL funding</p>
   </td>
   <td>
<ul>

<li>An advance-as-investment up front for an agreed upon return.
</li>
</ul>
   </td>
  </tr>
...
<li>Creating extracts of the book for promotional content.

<li>Serialize (<em>e.g.</em>, Twitter, blogs).

<li>115-second videos.
</li>
</ul>
   </td>
  </tr>
...
<li>Short videos (<em>e.g.</em>115-second videos).

<li>Publish serial form of content/extracts.

<li>Run campaigns on Twitter, LinkedIn, etc.
</li>
</ul>
   </td>
  </tr>
...
<li>Keynotes, featured speakers.

<li>Podcast guests.

<li>The voice of courses and workshops.
</li>
</ul>
   </td>
  </tr>
  ...
  <tr>
   <td>
    <p style="text-align: right">RADICALS.LIVE</p>
   </td>
   <td>
<ul>

<li>See <a href="https://docs.google.com/document/d/1NElxng620-FtPtk2s-2xizTcL_89LdqnpkZepsnf5RA/edit#heading=h.gqizizpnpgzu">RADICALS.LIVE</a>.
</li>
</ul>
   </td>
  </tr>
...
<p id="gdcalert1" ><span style="color: red; font-weight: bold">>>>>>  gd2md-html alert: undefined internal link (link text: "The PRADERA SHELF"). Did you generate a TOC? </span><br>(<a href="#">Back to top</a>)(<a href="#gdcalert2">Next alert</a>)<br><span style="color: red; font-weight: bold">>>>>> </span></p>

<a href="#heading=h.8yqs9zy5std9">The PRADERA SHELF</a>.
</li>
</ul>
   </td>
  </tr>
...
<h2>Sales</h2>
  ...
  <tr>
   <td>
    <p style="text-align: right">Feet on the street</p>
   </td>
   <td>
<ul>

<li>Sales to independent book sellers.

<li>Sales to large booksellers.

<li>Sales to airport booksellers.

<li>Bulk sales to corporations.

<li>Bulk sales to workshops and other venues.
</li>
</ul>
   </td>
  </tr>
