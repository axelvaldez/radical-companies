...
<h1>Origin Story</h1>
 ...
 <table>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>Create a source of information about the <span class="_paradigm">RADICAL</span>.
     <li>rMedia becomes the MoTown  of <span class="_paradigm">RADICAL</span> content.
     </li>
    </ul>
   </td>
  </tr>
  ...
  <tr>
   ...
   <td>
    <ul>
     ...
     <li>Being a <span class="_paradigm">rMedia</span> author (<em>i.e.</em>, progressive, future positive).</li>
