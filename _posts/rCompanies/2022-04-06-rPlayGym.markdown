...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Intro</h1>
 <p>The way most recruiting happens today is inefficient and ineffective; it does not work as well as it should. Businesses waste a huge amount of time and effort looking for people who magically fit their needs or, worse, they look for unicorns. But the “perfect fit” is an expensive fantasy.
 <p>When confronted with a “seller’s market,” desperation sets in and the whole thing turns into a search for “bodies.” A lot of people are hired who never match their teams and it gets very painful on all sides. This approach, too, is wasteful as well.
 <p>The rPlayGym approach is to help teams grow by helping people grow.1 The strength of a team is in how people complement each other with their whole person, not just with their technical skills. Think of it as the moral equivalent of Moneyball 2 for tech teams.

<h1 style="font-size:40px; font-family:Courier New, monospace; ">Alignment</h1>
 <table>
  <tr>
   <td colspan="2">
    <p style="text-align: right; font-weight: bold;">Impact</p>
   </td>
  </tr>
  <tr>
   <td>
  ...
  <tr>
   <td colspan="2">
    <p style="text-align: right; font-weight: bold;">Purpose</p>
   </td>
  </tr>
  <tr>
   <td>
  ...
  <tr>
   <td colspan="2">
    <p style="text-align: right; font-weight: bold;">Mission</p>
   </td>
  </tr>
  <tr>
   <td colspan="2">
  ...
  <tr>
   <td>
    <ul>
     <li>Launch three UNICORN HATCHERIES in 18 months.</li>
    </ul>
   </td>
  </tr>
  <tr>
...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Farm Programs</h1>
 <p>This is how Major League Baseball ranks a team’s farm program,<sup>3</sub></p>
 <table>
  <tr>
   <td>
...
<h1 style="font-size:50px; text-align:center; font-family:Courier New, monospace; ">APPENDICES</h1>
...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Office Hours</h1>
 <p>Offer rejected candidates to join you for Office Hours. For example, you could commit to doing two sessions per week, one hour each.</p>
...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Holding on to Your Chicken</h1>
 <p>The “chicken” comes from an illustration that Kimberly Wiefling4 uses in her workshops where she holds a rubber chicken up over her head, let go of it, and let it fall to the floor. Then she asks, “what happened to the chicken?” The responses are usually all over the place, but every so often a small voice says, “… because you let it go of it?” And that’s the point: you let go of your power, your essence, to others. And those more powerful than you grab it as soon as you let go of it.</p>
...
Related
RADICAL COMPANIES,
English <https://radicals.world/fDm2eL>
Castellano <https://radicals.world/3BFuoJ>
For the Impatient: RADs, PRI, etc. <https://radicals.world/Q0RIWR]>
Frequently asked questions (FAQ) <https://radicals.world/ZVRbBc>
The missing chapters,
RADICAL COIN <https://radicals.world/AzS0ao>
RADICAL LAND <https://radicals.world/1dW1z1>
RADICAL GOVERNMENT <https://radicals.world/elLrl7>
rCompanies
rPRADERA MEDIA
PRADERA SHELF <>
PRADERA READER <>
...
rHatchery <>
The Hatchery Story
The Hatchery Conscious Foundation
rEnsemble <>
rTranslate <>
rCleanSpace <>
rAtHomeCare <>
...
EPISODE 01 – First of Earth <https://radicals.world/sPzTII>
EPISODE 11 – The FIAT Enclaves <https://radicals.world/KW4xmO>
RADICAL Ferengi <https://radicals.world/fHIfqD>

Endnotes
1.     n So-called “10x developers,” “super leads,” “genius developers,” etc.
2.     n For more information, see Moneyball <https://radicals.world/oQmxC7>
3.     n MLB Farm System Ranking Factors <https://radicals.world/ATiAcH> (alt., https://diigo.com/0jwkj3).
4.     n Kimberly Wiefling’s profile, <https://radicals.world/zHL0lt>