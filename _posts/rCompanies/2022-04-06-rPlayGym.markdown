...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Power Up</h1>
 <p>This program is for members who want to learn a new skill or a new stack,</p>
  <ul>
   ...
   <li>The Power Up program leverages the experience a developer has gained to deliver the equivalent of one year experience in a few weeks. Shifting to a new paradigm will take longer (e.g., from object oriented to functional).</li>
