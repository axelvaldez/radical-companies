...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Costs</h1>
 ...
 <table style="font-size:smaller; ">
  <tr style="vertical-align:text-top; ">
   <td style="border-right:1px solid black; padding-right:1em; ">
    <p style="text-align:right; font-weight:bold; font-size:larger; column-width:1in; ">Capital Investment</p>
   </td>
   <td>
    <ul>
 ...
 <table style="font-size:smaller; ">
  ...
  <tr style="vertical-align:text-top; ">
   <td style="border-right:1px solid black; padding-right:1em; ">
    <p style="text-align:right; font-weight:bold; font-size:larger; column-width:1in; ">Opportunity loss</p>
   </td>
   <td>
    <ul>
