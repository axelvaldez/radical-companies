...
<div style="background-color:beige; font-size:larger; font-family:american typewriter, serif; padding:1em; margin-bottom:30px; ">
 <p style="text-align:justify; margin:0; ">Compassion is the radicalism of our tim</p>
...
<hr>
<ol><li id="fn1">
<h6>    	Dave Logan, John King, Halee Fischer-Wright. <a href="https://a.co/1953Gkh">Tribal Leadership: Leveraging Natural Groups to Build a Thriving Organization</a>.  2008.</h6>
...
<hr>
<ol><li id="fn1">
<h6>    	Possibly, a good opportunity to get into an established company is when a new boss comes into the scene.  Particularly, when an inheriting child takes over a parent, such as when Ricard Semler took over after his father.</h6>

&nbsp;<a href="#fnref1" rev="footnote">&#8617;</a><li id="fn2">
<h6>    	Kenneth Blanchard, Spencer Johnson.  <a href="https://www.goodreads.com/quotes/580671-secret-2-one-minute-praising-help-people-to-reach">The One Minute Manager</a>.  Berkley Trade, February 15, 1986.</h6>
