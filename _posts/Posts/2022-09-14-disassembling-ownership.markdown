...
<h1>Diassembling Ownership</h1>
  <ul>
   ...
   <li>Instead of a static number of shares, ownership of a <span class="_paradigm">RADICAL</span> company is dynamic. As in, it changes from, say, month to month, based on contributions, as recognized by other co-owners.</li>
