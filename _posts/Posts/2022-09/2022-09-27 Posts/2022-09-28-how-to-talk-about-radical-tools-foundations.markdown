...
<h1><span class="_paradigm">RADICAL</span> Foundation Template</h1>
 ...
 <table align="center" style="width:80%; ">
  <tr>
   <th rowspan="2" style="text-align:center; font-weight:bold; border:1px solid black; " id="_rotate">PRINCIPLES</th>
  ...
  <tr style=" background-color:#EEEEEE; ">
   <th rowspan="2" style="text-align:center; font-weight:bold; border:1px solid black; " id="_rotate">COMMITTMENTS</th>
  ...
  <tr>
   <th rowspan="2" style="text-align:center; font-weight:bold; border:1px solid black; " id="_rotate">PRACTICES</th>
   <th>Belonging</th>
   <td>
