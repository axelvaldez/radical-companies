...
<h1>RADs! Apps</h1>
 <p>Another tools that we are depolying is the RADs! app. In collaboration with Xipe Technology, a Mexican company, we are about to launch a mobile app called <em>RADs!</em>.</p>
 <p>We talked about <span class="_paradigm">RAD</span>s in our book<a href="#en01"><sup id="bm01">1&nbsp;</sup></a>.</p>
...
<h1>&nbsp;</h1>
 <p>There is one more tool that we are using so far: <a href="https://radicalcompanies.com/2022/09/20/rcommunity-and-rcore" target="_blank">rCommunities</a>.</p>
