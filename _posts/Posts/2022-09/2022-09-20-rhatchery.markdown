...
<h1>rCommunities</h1>
 ...
 <p>There already are a few rCommunities.</p>
  ...
  <h2>#100lives</h2>
   ...
   <p>With <em>#100lives</em> we hope to enable people to benefit from the Silicon Valley economy, as Sales folks and Developers. Once we get this smoothed out, we will go after other talents (<em>e.g.</em>, Artists). BTW, the name is inspired by #100devs, &ldquo;<em>A FREE LIVE Coding Bootcamp</em>&rdquo;, this  program was founded by Leon Noel<a href="#en04"><sup id="bm04">4&nbsp;</sup></a> to &ldquo;<em>help POC unlock high growth careers as software engineers</em>.&rdquo;. The progam is working fantastically well.</p>
   <h2>rJourney</h2>
   <h2>Posits</h2>
   <h2>Small Bites</h2>
   <h2>70/30</h2>
