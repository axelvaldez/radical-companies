   ...
   <table style="width:90%; ">
    <tbody style="border:1px solid black;">
     ...
     <tr>
      ...
      <td>
       <p><em>CORE</em> is an interpretation service (<em>i.e.</em>, translations for the rest of us) focused on injuries covered by the US <em>Worker&rsquo;s Comp</em> insurance.</p>
