...
<h1>Convivium Pumps</h1>
 ...
 <p>The dividends are distributed according to the <span class="_paradigm">RAD</span>s each co-owner has, which is based on their contributions as recognized by each other.</p>
