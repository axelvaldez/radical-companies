...
<h1>Co-Ownership</h1>
 ...
 <p>The solution has to be dynamic and decentralized. And that is what a <span class="_paradigm">RAD</span> Distribution is and what the <span class="_paradigm">RAD</span>s! application makes possible. It is modern tool that makes the process painless, decentralized, and dynamic,
  <ul>
