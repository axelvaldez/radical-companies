...
<h1>World-Wide <span class="_paradigm">rCOIN</span>s</h1>
 ...
 <p>The old fiat money was a not transparent and could be accumulated, with all the problems that arose out of it. <span class="_paradigm">rCOIN</span>s avoided all those problems and it supported decentralized world-wide exchange that could nurture the next stage of innovation.</p>
