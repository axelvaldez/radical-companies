...
<h1>World-Wide <span class="_paradigm">rCOIN</span>s</h1>
 ...
 <p>The old fiat money could be accumulated, with all the problems that arose from it. <span class="_paradigm">rCOIN</span>s avoided all those problems and it supported decentralized world-wide exchange, plus they were transparent. We did&rsquo;t think of it at first, but it accelerated the next wave of innovations.</p>
 <p>Each <span class="_paradigm">rCOIN</span> came with an open log that detailed who minted them and what, if anything, is backing them, and other information that people could use to decide to accept them or not. Communities accepted <span class="_paradigm">rCOIN</span>s because they usually knew the people minting them or they knew people who knew the people minting them. Most importantly, communities wanted them to succeed and move their world forward.</p>
