...
<h1><span class="_paradigm">rCOIN</span>s</h1>
 <p>The bigger communities needed to something to keep track of exchanges. They came up with the <span class="_paradigm">rCOIN</span>,<a href="#en02"><sup id="bm02">&hairsp;&nabla;&hairsp;</sup></a> but it required computers. Which, as it so happened, several communities in the African continent were building. These computers were cobbled from whatever they could find, non-working devices and spare parts. Not as fast as pre-cliff computers, but fast enough to support <span class="_paradigm">rCOIN</span>s.</p>
