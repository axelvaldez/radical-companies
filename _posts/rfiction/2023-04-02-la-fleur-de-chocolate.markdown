...
<h1>More Complications</h1>
 <p class="_speaker"><span class="_speakerb">People earn one <span class="_paradigm">RAD</span> per day. Not to keep, but to give them out to their peers. At the end of, say, each month your contributions get converted to <span class="_paradigm">RAD</span>s and then something tangible like revenue comes in. The expenses are paid and what is left normally goes to the owner. In this case, what is left, the dividends, get distributed according to the <span class="_paradigm">RAD</span> you have. There a <span class="_paradigm">RAD</span>s! mobile app that takes care of that, the &ldquo;complication&rdquo;</span></p>
