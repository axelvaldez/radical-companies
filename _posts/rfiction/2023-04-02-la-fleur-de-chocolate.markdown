...
<h1>Back on Track</h1>
 ...
 <p class="_speaker"><span class="_speakerb">Whatever works for you, it&rsquo;s OK. <span class="_paradigm">RADICAL</span> is not a dogma. It simply is an alternative to <span class="_paradigm">FIAT</span> that works for co-owners, not just <span class="_paradigm">FIAT</span> owners.</span></p>
