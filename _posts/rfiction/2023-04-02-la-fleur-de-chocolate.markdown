...
<h1><span class="_paradigm">RAD</span>s</h1>
 <p class="_speaker"><span class="_speakerb">The contributions that you give reflect how you feel about what you see happening. You see behavior, you feel enthused about it, and you press the &ldquo;contributions&rdquo; button to your heart&rsquo;s content. You see behavior, you feel it is wrong, and you press the &ldquo;we need to talk&rdquo; button. But we want these contributions to be tangible, not empty backslaps.</span> I paused for a bit. <span class="_speakerbc">To make them tangible, you have to convert them to <span class="_paradigm">RAD</span>s. If you give somebody 10% of all your contributions and you have $100, they get $10, but if you have $1,000, they&rsquo;d get $100. That's wny we convert the contributions to <span class="_paradigm">RAD</span>s. Rather tan converting directly to dollars or euros, we convert to <span class="_paradigm">RAD</span>s because they serve to factor other things. Later when, for example, revenue comes in, that revenue is distributed according to the numbers of <span class="_paradigm">RAD</span>s you have. If you have twice as many <span class="_paradigm">RAD</span>s as me, you get twice as much profit as me.</span></p>
 <p class="_speaker"><span class="_speakerc">Still, it sounds very complicated.</span></p>
 <p class="_speaker"><span class="_speakerb">It is different, but really not that complicated. National currencies are more complicated, except the complication is hidden to you and me.</span></p>
 <p class="_speaker"><span class="_speakerc">That might be true, but it still sounds complicated.</span></p>
