...
<h1>The Voice Network</h1>
 ...
 <p>One of the things that became popular in the network was to ask how-to question. In response, people shared instructions on how to fix some things or how to build others. Younger people were more interested in how to make hair eco-color. <span class="_quotespan">I like your shade of brown, how do you make it?</span> one would ask. Most responded with the specific process, but there always was a smart ass who&rsquo;d say, <span class="_quotespan">You will also have to get yourself a brown shoulder to lean on!</span> People even learned how to patch transmissions from one broadcaster to another and, slowly, the connection grew the world over.</p>
...
<h1>Community Ensembles</h1>
 ...
 <p>Who knows, but maybe the deep understanding of what these communities were like would be their <span class="_quotespan">defense</span> in the future.</p>
