...
<h1>Precursors</h1>
 <p><img src="/assets/img/radical-escape-velocity.svg" style="text-align:top; margih-left:15px;  float:right; width:30%; " alt="RADICAL Escape Velocity image generated by hugging faces"><span class="_paradigm">RADICAL</span>-like groups have been around for a while: one comes up, others copy him, and they pick up some momentum, <em>but never enough</em>. The reasons range from the visionary leader passing away, dogma setting in, or the group being taken over by barbarians.</p>
