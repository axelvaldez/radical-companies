...
<h1>Salt of the Earth</h1>
 ...
 <p>We had renewable energy storage systems that communities and ensembles could build on.</p>
...
<h1>World-Wide rCoins</h1>
 ...
 <p>The old fiat money could be accumulated, with all the problems that arose from it. <span class="_paradigm">rCOIN</span>s avoided all those problems and it supported decentralized world-wide exchange. We didn&rsquo;t think of it at first, but it accelerated the next wave of innovations.</p>
