    ...
    <tr>
     ...
     <td>
      ...
      <p>For the case where all co-owners agree, the Banner could look like this,</p>
       <table>
        <tr>
         <th style='background-color:yellow; width:25rem; text-align:left; '>Banner:</th>
...
<h1 class='_section'>Explicit Relationships</h1>
 <div class='_center'>
  <table class='_h2table'>
   <tr>
...
<h1 class='_section'>Explicit Alignment</h1>
 <p>
...
<h1 class='_section'>Explicit Profile</h1>
...
<h1 class='_section'>RADs</h1>
 ...
 <p>The reason I think that the RADs! Mobile App is fundamental is because it is likely the sharp end of the Radical spear,</p>
   <div class='_center'>
    <table class='_h2table'>
     <tr>
