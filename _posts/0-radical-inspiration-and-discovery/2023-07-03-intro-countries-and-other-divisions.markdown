...
<h1>Divide and Conquer</h1>
 <p>At some point women were made the property of men and were made subservient to them. That is, for example, why inherited last names are the man&rsquo;s. The “ez” at the end of Spanish family names (<em>e.g.</em>, Per<em>ez<em>) is the equivalent to the possessive English (<em>e.g</em>, Pedro&rsquo;s). It indicated people with that last name &ldquo;belonged to&rdquo; the man called Pedro. Men were the kings of their castle and women were reduced to chattel. Sounds comical, but there is an intuitive logic to it: men now had to worry about staying in control of what belonged to them, and not about the injustices from the powerful men above.</p>
