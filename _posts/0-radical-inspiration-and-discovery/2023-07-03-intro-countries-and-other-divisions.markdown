...
<h1>Divide and Conquer</h1>
 <p>At some point women were made the property of men and were made subservient to them. That is, for example, why inherited last names are the man&rsquo;s. For exaple, the “<em>ez</em>” at the end of Spanish family names (<em>e.g.</em>, Per<em>ez</em>) is the equivalent to the possessive English (<em>e.g</em>, Pedro&rsquo;s). It indicated that people with that last name &ldquo;belonged to&rdquo; the man called Pedro. Men were the kings of their castle and everybody, including women, were reduced to chattel. Sounds comical new, but there is an intuitive logic to it: men now had to worry about staying in control of what belonged to them, and not about the injustices from the powerful men above.</p>
