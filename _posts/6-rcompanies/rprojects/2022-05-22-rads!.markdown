 ...
 <div class="_center">
  <table class="_explicitalignment">
   ...
   <tr>
    ...
    <td>
     <p>There is no hard criteria for this and could be any kind of contribution, whatever the user considers a valuable contribution (<eg>e.g.</eg>, number of checkins, a significant conversation).</p>
      <ul>
