...
<h1>Questions, Questions</h1>
 ...
 <p>Notice that <em>chatGPT</em> never questions the &ldquo;job&rdquo; concept, it assume that you will have a one. It never asks, <span class="_quotespan">Why should you have a job at all?</span> Its language training base assumes that you must exchange yout time and skills for a wage, that you must exchange your life for enough money to survive. But working for a <span class="_paradigm">FIAT</span> wage is the critical question for systemic change.</p>
 <p>Such is the <span class="_paradigm">FIAT</span> system we live in: the grand mamority of us only aspire to a good paying job, regardless of the cost to us.</p>
