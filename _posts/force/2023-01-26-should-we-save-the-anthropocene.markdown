...
<h1>Ownership</h1>
 ...
 <p>Owners is a human invention and a very good one at that. Ownership care for their property, etc. I am not sure if that is the way it really works or that is the way that it has worked out, but, in any case, let’s go with that assumption. Then ownership, as a good thing, should be spread out to everybody, not just a few.</p>
