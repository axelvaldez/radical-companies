...
<h1>Questions, Questions</h1>
 ...
 <p>Notice that it never questions that will have a &ldquo;job,&rdquo; even though that is the critical question for systemic change. It never asks, <span class="_quotespan">Why should I have a job at all?</span> The <em>chatGPT</em> language training set is biased towards &ldquo;jobs.&rdquo; It assumes that you must exchange yout time and skills for a wage, your life for enough money to not fall into poverty.</p>
