...
<h1>Shorter and Efficient</h1>
 <p>If my description of problem solving in a <span class="_paradigm">Radical</span> company seems shorter to you, it is because it is actually shorter: you post a <span class="_paradigm">BANNER</span>, have a few conversations, and your peers support you. Even if they don&rsquo;t fully fund your <span class="_paradigm">BANNER</span>, you learn (<eg>e.g.</eg>, alternative ways of addressing the problem).</p>
