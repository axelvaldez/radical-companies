...
<div class='_center'>
 <table class="_explicitalignment">
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>Launch three <span class="_paradigm">rPlayGym</span>s in 18 months.</li>
    </ul>
   </td>
  </tr>
  <tr>
...
<h1>Farm Programs</h1>
 <p>This is how the US Major League Baseball ranks a team&rsquo;s farm program,<a href="#en03"><sup id="bm03">&hairsp;&nabla;&hairsp;</sup></a></p>
  ...
  <table class='_h2table'>
   ...
   <tr>
    <th>Team High\2011End Talent</th>
    <td>
     <p>That being said, there is a difference between a prospect who could make an impact at the big league level and a prospect who could be a star. High\2011end talent served as a tiebreaker of sorts when two teams were close in the rankings.</p>
    </td>
   </tr>
  </table>
 </div>
...
<h1>Costs</h1>
 ...
 <table class='_h2table'>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>Once you have a <span class="_paradigm">rPlayGym</span> in place, it generates people who are well integrated with your teams continuously.</li>
    </ul>
   </td>
  </tr>
  <tr>
  ...
  <tr>
   <th><span class="_paradigm">rPlayGym</span> Benefits</th>
   <td>
    <ul>
     <li>Mentee: Learns her craft, tech skills, how to set goals, and communication skills. They also learn your culture alongside experienced mentors. If there&rsquo;s no fit, the mentee will be the first to figure it out.</li>
 ...
 <p>The <span class="_paradigm">rPlayGym</span> approach is more efficient and lots more effective over the long term. Also, it is more satisfying and enjoyable as a predictable source of growth for people and your company.</p>

<h1>How It Works</h1>
 <p>This is a schematic depiction of the current recruiting pipeline,</p>
  <img
   src="/assets/img/recruiting-pipeline-default.svg"
  ...
  >
 <p>The <span class="_paradigm">rPlayGym</span> is a drastically different approach to growing a team. Although it still works with the traditional academia/industry scheme, as it has to, it changes its relationship to it,</p>
 <ul>
  ...
  <img
   src="/assets/img/recruiting-pipeline-rplaygym.svg" 
   alt="The rPlayGym is a flow that starts at home and continues through the whole life path. There is no hard wall between 'Academia' and 'Industry.' This is all supported by graduated educational and training programs guided by the 'students' and given by people who know about the subject."
  >
 ...
 <ul>
  ...
  <li>Tech Screen,</li>
   ...
   <li>Profile interview,</li>
    <ul>
     <li>Check for cultural alignment (<eg>i.e.</eg>, according to your Impact, Purpose, and Mission or whatever Alignment principles you use).</li>
    ...
    <li>Task interview,</li>
     <ul>
      ...
      <li>One interviewer acts as a distractor (<eg>i.e.</eg>, to learn if the candidate is easily distracted or not, and whether she loses her train of thought easily or not).</li>
     ...
     <li>Thumbs meeting</li>
      <ul>
       ...
       <li>They disclose their ratings (<eg>e.g.</eg>, Planning Poker) and discuss results.</li>
...
<h2>Incubator</h2>
 <p>This Incubator is for people who is missing a key skill, or doesn&rsquo;t have experienced with a particular technology,</p>
  <ul>
   ...
   <li>Share the team&rsquo;s estimate (<eg>i.e.</eg>, usually their estimate is lower than the team&rsquo;s).</li>
...
<h2>Power Up</h2>
 <p>This program is for members who want to learn a new skill or a new stack,</p>
  <ul>
   ...
   <li>The Power Up program leverages the experience a developer has gained to deliver the equivalent of one year experience in a few weeks. Shifting to a new paradigm will take longer (<eg>e.g.</eg>, from object oriented to functional).</li>
