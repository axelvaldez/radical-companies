...
<h1>How It Works</h1>
 <p>This is a schematic depiction of the current recruiting pipeline,</p>
  ...
  >
 <p>The <span class="_paradigm">rPlayGym</span> is a drastically different approach to growing a team. Although it still works with the traditional academia/industry scheme, it changes its relationship to it,</p>
 <ul>
