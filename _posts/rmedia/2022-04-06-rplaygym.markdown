...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Intro</h1>
 ...
 <p>The rPlayGym approach is to <em>help teams grow by helping people grow</em>.<sup id="id01"><a href="#en01">1</a></sup> The strength of a team is in how people complement each other with their whole person, not just with their technical skills. Think of it as the moral equivalent of <em>Moneyball</em> <sup id="id02"><a href="#en02">2</a></sup> for tech teams.</p>
...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">Farm Programs</h1>
 <p>This is how the US Major League Baseball ranks a team’s farm program,<sup id="id03"><a href="#en03">3</a></sup></p>
 <table style="font-size:smaller; margin-bottom:10px; ">
  <tr style="vertical-align:text-top; ">
