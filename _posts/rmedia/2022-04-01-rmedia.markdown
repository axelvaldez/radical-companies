   ...
   <tr>
    ...
    <td>
     <ul>
      ...
      <li>Organized as a <span class="_paradigm">Radical</span> company.  Everybody who contributes (<eg>e.g.</eg>, authors, distributors, printers) participates in its ownership and the wealth it generates.</li>
     </ul>
    </td>
   </tr>
   <tr>
   ...
   <tr>
    ...
    <td>
     <ul>
      ...
      <li>Being an <span class="_paradigm">rMedia</span> author (<eg>i.e.</eg>, progressive, future positive).</li>
    ...
    <tr>
     ...
     <td>
      <ul>
       ...
       <li>Training in the use of new tools (<eg>e.g.</eg>, InDesign, Jutoh, rMake).</li>
       <li>Mentoring (<eg>i.e.</eg>, tools to find  an experienced author).</li>
      </ul>
     </td>
    </tr>
    <tr>
  ...
  <div class='_center'>
   <table class='_h2table'>
    <tr>
     ...
     <td>
      <ul>
       ...
       <li>Serialize (<eg>e.g.</eg>, Twitter, blogs).</li>
    ...
    <tr>
     ...
     <td>
      <ul>
       <li>Short videos (<eg>e.g.</eg>115-second videos).</li>
