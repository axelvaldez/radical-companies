 ...
 <p>The  resulting distribution package will include,</p>
  <div class='_center'>
   <table>
    ...
    <colgroup>
     <!--                 --> <col style="font-size:smaller; background-color:#eee;ound-color:#yellow; border-right:1px solid black; ">
     <!-- Duration        --> <col style="font-size:smaller; background-color:#eee; background-color:#yellow; ">
     <!-- What            --> <col style="font-size:smaller; ">
     <!-- Target Audience --> <col style="font-size:smaller; background-color:#eee; background-color:#cyan; ">
    </colgroup>
    <tr>
     <th>Episode</th>
     <td>
