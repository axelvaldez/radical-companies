 ...
 <p>The  resulting distribution package will include,</p>
  <div class='_center'>
   <table style="width:80%; ">
    ...
    <rowgroup>
     <!-- 1 --> <row style="font-size:smaller; ">
     <!-- 2 --> <row style="font-size:smaller; ">
     <!-- 3 --> <row style="font-size:smaller; ">
     <!-- 4 --> <row style="font-size:smaller; ">
     <!-- 5 --> <row style="font-size:smaller; ">
     <!-- 6 --> <row style="font-size:smaller; ">
    </rowgroup>
    <tr>
