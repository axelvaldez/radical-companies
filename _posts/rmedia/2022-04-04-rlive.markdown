  ...
  <div class='_center'>
   <table class='_h2table'>
    <tr style="text-align:center; border-bottom:1px solid black; ">
     <th style="width:20en; ">&nbsp;</th>
     <th style="width:20en; ">Duration</th>
     <th style="width:20en; ">What</th>
     <th style="width:20en; ">Target Audience</th>
    </tr>
   </table>
  </div>
  <div class='_center'>
   <table class='_h2table'>
    <colgroup>
     <!--                 --> <col style="">
     <!-- Duration        --> <col style="background-color:#eee; background-color:yellow; ">
     <!-- What            --> <col style="font-size:smaller; ">
     <!-- Target Audience --> <col style="background-color:#eee;">
    </colgroup>
    <tr>
     <th style="width:20en; ">Episode</th>
     <thxxx style="width:20en; ">
      <ul>
       <li>90 min</li>
      </ul>
     </th>
     <th style="width:20en; ">Live streamed and recorded</th>
     <th style="width:20en; ">For co-owner-wanna-bes</th>
    </tr>
    <tr>
     <th>Hour</th>
     <td>
 ...
 <h2>Production</h2>
  <div class='_center'>
   <table clas='_h2table'>
    ...
    <tr>
     <th>Planning</th>
     <t>Includes all preparations before a show for optimal experience,
      <ul>
