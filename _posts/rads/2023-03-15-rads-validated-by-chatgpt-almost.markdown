  ...
  <table class="_background">
   ...
   <tr>
    ...
    <td>
     ...
     <p>An alternative to <span class="_paradigm">FIAT</span> is practical, feasible, and necessary. And it is a better option for business individually and the overall economy. We admit that it is a bad alternative if all you have is capital and can&rsquo;t offer anything else.</p>
    </td>
   </tr>
   <tr>
