 ...
 <div class="_center">
  <table class="_background">
   ...
   <tr>
    ...
    <td>
     <p>This is another default <span class="_paradigm">FIAT</span>s system reaction to anything that is perceived as an existential threat. <span class="_quotespan">Be afraid. Be very afraid.</span></p>
