...
<h1>RADs vs Results</h1>
 <p>Matt believes that it is fine to give the money or whatever results from the <span class="_paradigm">RAD</span>s, but not the R<span class="_paradigm">RAD</span>sADs themselves. The assignment is transparent and anybody can see it. <span class="_quotespan">Whatever factors through these <span class="_paradigm">RAD</span>s, goes to&hellip; .</span></p>
