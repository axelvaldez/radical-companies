...
<h1>A Unit of Distribution</h1>
 ...
 <p>As we tried to use <span class="_paradigm">RAD</span>s in the early versions of the <em>RADs! app</em>, it got too clumsy and cumbersome. Co-onwers would end up adding and subtracting <span class="_paradigm">RAD</span>s, which is exactly what we didn&rsquo;t want. We wanted to capture the <em>feeling instensity</em> that an observed contributionbrought up.</p>
