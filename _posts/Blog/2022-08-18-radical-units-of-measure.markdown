...
<h1><span class="_paradigm">REC</span> as a Unit of Recognition</h1>
 ...
 <p>At the end of the cycle, the <span class="_paradigm">REC</span>s that Deb gave other co-owners are converted to <span class="_paradigm">RAD</span>s. First, the number of <span class="_paradigm">REC</span>s a co-owner gave during the cycle is divided by the total of <span class="_paradigm">REC</span>s she gave. This percentage is then multiplied by the number of <span class="_paradigm">RAD</span>s a co-owner received during the cycle (<em>e.g.</em>, 30 on a monthly cycke) to get the number of <span class="_paradigm">RAD</span>s each co-owners gets from the giving co-owner.</p>
