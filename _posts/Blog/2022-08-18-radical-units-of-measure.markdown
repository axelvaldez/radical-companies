...
<h1><span class="_paradigm">REC</span> as a Unit of Recognition</h1>
 ...
 <p>The <em>RADs! app</em> lets a co-owner press a recognition button as many times as she feels like it (<em>i.e.</em> eeally, there's no limit) to capture the <em>intensity</em> of the feeling that the contribution brought up in the giving co-owner. At the end of the cycle, <span class="_paradigm">REC</span>s are converted to <span class="_paradigm">RAD</span>s.</p>
 <p>To convert <span class="_paradigm">REC</span>s to <span class="_paradigm">RAD</span>s. First, the number of <span class="_paradigm">REC</span>s a co-owner gave during the cycle is divided by the total of <span class="_paradigm">REC</span>s she gave. This percentage is then multiplied by the number of <span class="_paradigm">RAD</span>s a co-owner received during the cycle (<em>e.g.</em>, 30 on a monthly cycke) to get the number of <span class="_paradigm">RAD</span>s each co-owners gets from the giving co-owner.</p>
