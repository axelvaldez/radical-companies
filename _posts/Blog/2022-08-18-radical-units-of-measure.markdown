...
<h1><span class="_paradigm">REC</span> as a Unit of Recognition</h1>
 ...
 <p>The <em>RADs! app</em> lets a co-owner press a recognition button as many times as she feels like it (<em>i.e.</em> eeally, there's no limit) to capture the <em>intensity</em> of the feeling that the contribution brought up in the giving co-owner. At the end of the cycle, <span class="_paradigm">REC</span>s are converted to <span class="_paradigm">RAD</span>s. To do this, the number of <span class="_paradigm">REC</span>s a co-owner gave during the cycle are divided by the total number of <span class="_paradigm">REC</span>s she gave. This percentage is then multiplied by the number of <span class="_paradigm">RAD</span>s a co-owner received during the cycle (<em>e.g.</em>, 28, 29, 30, or 31 days if monthly cycle). These are multiplied by the percentage of <span class="_paradigm">REC</span>s one co-owner gave to others to other co-owners gave throughout the cycle to figure out how many <span class="_paradigm">RAD</span>s other co-owners get from us.</p>
