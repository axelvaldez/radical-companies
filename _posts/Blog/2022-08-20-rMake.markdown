...
<pre class="prettyprint" style="font-size:25px; text-align:center; border:1px solid CadetBlue; background-color:beige; font-family:American Typewriter, serif; white-space:normal; padding:1em; ">
 A book would no longer be a book, but (parallel) variations on a theme. A spectrum of perspectives, built like software is done these days. This made me think of how Aztecs used to keep track of histories.<br>
&mdash;Marysol Ortega, PhD
</pre>
