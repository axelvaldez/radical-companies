...
<h1>But You Already Can&hellip;</h1>
 <p>My first thought was that any of the various Git<a href="#en01"><sup id="bm01">1&nbsp;</sup></a> platforms, MediaWiki,<a href="#en02"><sup id="bm02">2&nbsp;</sup></a> or even Google Docs could be it.</p>
 <h2>Git</h2>
  <table>
   <tr>
    <th>PROs</th>
    <td>
     <ul>
      <li>Git is a very popular software source control system. It allows software developers to work as peers, in parallel.</li>
 ...
 <h2>MediaWiki</h2>
  <table>
   <tr>
    ...
    <td>
     <ul>
      <li>This is the wiki engine used by Wikipedia and it is friendly enough for writers. At least those who are used to Wiki Markup.<a href="#en03"><sup id="bm03">3&nbsp;</sup></a></li>
      ...
      <li>It has pretty good documentation for developers.<a href="#en04"><sup id="bm04">4&nbsp;</sup></a></li>
     </ul>
    </td>
   </tr>
  </table>
...
<h1>Then Came rMake!</h1>
 <p>In the end, we opted to create a new app we call rMake as an OSS platform that others can extend. There are several OSS editors that we can leverage for our UI. Also, there are many OSS components and libraries that we can use in the making of rMake (<em>e.g.</em>, diff).<a href="#en05"><sup id="bm05">5&nbsp;</sup></a></p>
 <h2>No Trunk</h2>
 ...
 <h2>Authorship & Ownership</h2>
  ...
  <ul>
   ...
   <li>Ownership does not imply exclusivity and anybody can copy any fragment in a flow at will. As noted, the fragment ownership goes along with it.
...
<h1 class="_section">Contributions</h1>
...
<h1>Roles</h1>
 ...
 <h2>Co-Writers</h2>
  ...
  <ul>
   ...
   <li>Fork a particular fragment, be it a section or subsection, a paragraph, a sentence, phrase, or excursus.<a href="#en07"><sup id="bm07">7&nbsp;</sup></a></li>
   <li>
    <p style="margin-bottom:0; ">Create a Pull Request<a href="#en11"><sup id="bm11">11&nbsp;</sup></a> to,</p>
    <ol>
...
<h1>References</h1>
 <p>An rMake reference can include text, URLs, or both, a la Kindle.</p>
...
<h1 class="_section">ENDNOTES</h1>
 ...
 <ol>
  ...
  <li id="en02">
   <p class="_list-item">
    <em>MediaWiki</em>.
    <<a href="https://www.mediawiki.org/wiki/MediaWiki">https://www.mediawiki.org/wiki/MediaWiki</a>>
  ...
  <li id="en04">
   <p class="_list-item">
    <em>documentation for developers</em>.
  ...
  <li id="en05">
   ...
   <p class="_list-item">
    For the backend, we were planning to use _Prtcl, an OSS projec. Unfortunately, _prtcl is no more. It was based on blockchain and very much aligned with our goals.
    <<a href="https://github.com/uprtcl">https://github.com/uprtcl</a>>
  ...
  <li id="en06">
   <p class="_list-item">
    ...
    <<a href="https://www.google.com/search?q=excursus&oq=excursus">excursus</a>>
  ...
  <li id="en07">
   <p class="_list-item">
    ...
    <<a href="https://en.wikipedia.org/wiki/Fork_and_pull_model">Pull Request</a>>
  ...
  <li id="en09">
   <p class="_list-item">
    Darrell Huff and Irving Gels.
    <em>How to Lie with Statics-Darrel-Huff</em>
    1993.
    <<a href="https://radicals.world/1VWoUn">&hellip;https://radicals.world/1VWoUn</a>>
