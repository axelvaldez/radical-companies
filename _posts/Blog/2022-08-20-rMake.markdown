...
<h1>Flows</h1>
 <p>Flows tie together a number of segments to make for a coherent reading. Flows are first-class objects, persistent and publishable. For example, assume a book project starts with two authors and ends with many contributors from different authors,</p>
 <div style="text-align:center; ">
  <img
   src="/assets/img/rmake-flow-1.svg"
   width="70%"
   alt="The image shows two flows. Each flow is made up of four segments. Segments 1, 3, and 4 are by author1 and segment two is by author2. To the right of the orignal flow is another one. This one starts with with a segment by author1; segments two is co-authored by author1 and author2; segment three is coauthored by author2 and author 5; segment 4 is coauthored by author1, author2, and author4. Presunably, authors 3 and 4 made a contribution and later retracted it.">
 </div>
 <p>Imagine these flows in between,</p>
 <div style="text-align:center; ">
  <img
   src="/assets/img/rmake-flow-all.svg"
   width="70%"
   alt="">
 </div>
 ...
 <div style="text-align:center; ">
  <img
   src="/assets/img/rmrmake-flow-all.svg"
   width="70%"
   alt="">
 </div>
...
<h1>Publishing</h1>
 ...
 <p>See <a href="#">rMEDIA</a><a href="#en10"><sup id="bm10">10&nbsp;</sup></a> for more info.</p>
...
<h1>Roles</h1>
 ...
 <h2>Co-Writers</h2>
  ...
  <ul>
   ...
   <li>Fork a particular fragment, be it a section or subsection, a paragraph, a sentence, phrase, or <a href="https://www.google.com/search?q=excursus&oq=excursus">excursus</a>.<a href="#en11"><sup id="bm11">11&nbsp;</sup></a></li>
   <li>
    <p style="margin-bottom:0; ">Create a <a href="https://en.wikipedia.org/wiki/Fork_and_pull_model">Pull Request</a><a href="#en12"><sup id="bm12">12&nbsp;</sup></a> to,</p>
    <ol>
