...
<img style="margin:0; float:right; " src="/assets/img/co-ownership -big-bite-small-bite" alt="The heading read Co-Ownership. Below it there are two circles with bit marks in their upper-left. The circle on the left is big and it's label 'All of It;' the circle on the right is smaller ans it is labelled 'Smaller Bites.'" width="30%">
