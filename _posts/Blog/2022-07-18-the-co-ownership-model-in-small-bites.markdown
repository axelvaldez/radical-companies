...
<h1 style="font-size:40px; font-family:Courier New, monospace;  margin-top:50px; ">The Big Pill</h1>
 ...
 <img style="margin:0; float:right; font-family:Courier New, monospace; " src="/assets/img/co-ownership-big-bite-small-bite" alt="The heading reads Co-Ownership. Below it there are two circles with bit marks in their upper-left. The circle on the left is big and it's label 'All of It;' the circle on the right is smaller ans it is labelled 'Smaller Bites.'" width="30%">
 </p>
