...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">RAD Distributions</h1>
 <p>This is all about recognizing contributions and assigning them a value. That is what the boss is doing, sometimes is contributions to the bottom line, other times it's about contributions to the operations, and still other is based on contributions to the boss' ego. There is no way to tell and it's based on the opinion of a handful of people. <span style="font-size:smaller; ">RAD</span> Distributions do the same thing, but let's everybody participate, not just the bosses.</p>
