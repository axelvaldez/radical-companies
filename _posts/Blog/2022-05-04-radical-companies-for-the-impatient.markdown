...
<h1 style="margin-bottom:15px; ">The <span class="_paradigm">RADICAL</span> Model</h1>
 <h2>Businesses-as-Dictatorships Hurt Us</h2>
  ...
  <p>Nature follows a simple path to create big beautiful things out of small, unpretentious ones. From a tiny seed to a mighty oak tree. We don&rsquo;t think that a long list of principles or color scales or a 17 page constitution are necessary, or even helpful, to make a fundamental change. Eventually, these can become dogma, a form of force, and sabotage our progress. With that in mind, we came up with what we think are the most basic foundation to support our coming together to share work and wealth.</p>
