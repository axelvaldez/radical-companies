...
<h1 style="font-size:40px; font-family:Courier New, monospace; ">The <span class="_paradigm">RADICAL</span> Model</h1>
 ...
 <h2>Alignment Must Be Explicit and Transparent</h2>
  ...
  <ul>
   <li>Impact is our beacon, a clear point of light just over the horizon that guides us. This is what many call Vision but we wanted to put more emphasis on the <em>impact</em> that vision will have on the world.</p>
