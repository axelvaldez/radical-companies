...
<h1>Salaries Are a Gift</h1>
 ...
 <h1>So, Let&rsquo;s Give Everybody Stock!</h1>
  <p>I&rsquo;ve worked in high tech my whole adult life. The early employees got stock, presumably in exchange for the risk they took. Then, at some point, new people would get less and less stock, and finally none. And, it stands to reason: the employee pool was a fixed size and after a while it dries out. But note that regardless of stock class they get (<em>e.g.</em>, founder, common), employees don&rsquo;t get anything other than a financial promise with their stock; only <em>Officers</em> <em>i.e.</em> bosses) have any control of the business itself.
