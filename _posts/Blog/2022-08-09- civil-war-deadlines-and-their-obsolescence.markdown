...
<h1>&nbsp;</h1>
 ...
 <h1>No Emgagement. No Ownership.</h1>
...
<h1>Fear Is All You Know</h1>
 <p>As you move down the <span class="_paradigm">FIAT</span> hierarchy, it becomes more and more justified to use deadlines that cause people to fear for their jobs. In a <span class="_paradigm">FIAT</span> business, as tangible owneship and engagement dissappears, fear is all that's left to move <em>those at the bottom</em>.</p>
