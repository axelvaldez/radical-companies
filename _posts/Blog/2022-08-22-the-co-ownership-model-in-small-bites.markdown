...
<h1><span class="_paradigm">RAD</span>s</h1>
 ...
 <p><span class="_paradigm">RAD</span>s are a tool for decentralizing the recognition of contributions. It is similar to what they boss does in his head, but, instead, lets everybody do it. And their distribution is fully transparent, including what the reason the contrinution is being recognized. <span class="_paradigm">RAD</span>s make contributions <em>tangible</em>. <span class="_paradigm">RAD</span>s can later be translated to a percentage of, say, profits (<em>i.e.</em>, earned dividends).</p>
