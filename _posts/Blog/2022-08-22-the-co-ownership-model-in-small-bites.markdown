...
<h1><span class="_paradigm">RAD</span>s</h1>
 ...
 <p><span class="_paradigm">RAD</span>s do a similar thing, but lets everybody do it, not just the boss. And their distribution is fully transparent, including what the recognition is for. Instead of an attaboy, <span class="_paradigm">RAD</span>s make these recognitions <em>tangible</em>. <span class="_paradigm">RAD</span>s can later be translated to a percentage of, say, profits (<em>i.e.</em>, earned dividends).</p>
