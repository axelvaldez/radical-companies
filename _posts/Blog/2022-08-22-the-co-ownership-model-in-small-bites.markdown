...
<h1>Building Communities: Research</h1>
 <p>Recently Adrian Perez, a RADICAL COMPANIES co-author, pointed me to <em>Growing through Sabotage</em><a href="#en03"><sup id="bm03">3&nbsp;</sup></span>, a fantastic paper (<em>i.e.</em> long but worth it). Their hypothesis is that capital is power (<em>i.e.</em> and capital really is quantified energy extracted from other people). In it, they cite Blair Fix&rsquo;s work several times. And, as it so happens, Blair Fix has his own Patreon page.<a href="#en04"><sup id="bm04">4&nbsp;</sup></span></p>
 <p>Bichler and Nitzan could form a community by inviting Fix and any adjacent researcher, and this community can have a Patreon page. The Patreon funds could be distributed to people in the community on a regular basis based the number of <span class="_paradigm">RAD</span>s each researcher receives for their community peers. I, for one, would prefer to sign up to support that community rather than single researchers. For me, the sponsor, I could post questions to the community and have access to all their work. For the community members themselves, they could help each other by reviewing each other&rsquo;s papers, providing their prespectives, co-authoring,<a href="#en05"><sup id="bm05">5&nbsp;</sup></span></a>, etc</p>
 <p>Also, a community of researchers has built-in trust. And that trust will be modulated by the number of <span class="_paradigm">RAD</span>s each researcher has been given. The more <span class="_paradigm">RAD</span>s a researcher has, the more he can be trusted. For example, there are researches who don&rsquo;t publish a lot of papers, but contribute in other ways to the community. In the traditional academic community, they don't get much recognition and are relegated to second banaa roles. But a community <em>knows</em> the value of their contributions and he could end up with a lot of recognitions.</p>
 <p></p>
