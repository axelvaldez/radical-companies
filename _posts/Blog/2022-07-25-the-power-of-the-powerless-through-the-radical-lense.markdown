...
<table>
 ...
 <tr>
  ...
  <td>
   ...
   <p>Most of us tend to interpret this as, &rdquo;<em>thank goodness, because if it weren't for businesses and the military would not have nice things like bridges, roads, and schools.</em>&rdquo; Sadly, this mindset is literally burning our life boat. It is going to be difficult to get, but centralized power stands in our way of thriving: it is hostile to innovation, and creativity, and commerce. What innovation happens, for example, in pharmaceuticals is accidental and in any case it ends up as private goods. If you believe, like I do, that decentralized ownership (<em>i.e.</em> democracies) is better than uber centralized ownership (<em>i.e.</em>, the State)<a id="bm12" href="#en12"><sup>12</sup></a>, then it follows that we sould insist continuing to move towards decentralization. But it goes against everything we &ldquo;know,&rdquo; doesn&rsquo;t it?</p>
  </td>
 </tr>
 <tr>
  <td class="_spacer">&nbsp;</td>
