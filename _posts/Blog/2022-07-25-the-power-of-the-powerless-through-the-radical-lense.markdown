...
<table>
 ...
 <tr>
  ...
  <td>
   ...
   <p>Even the public goods benefit businesses and the government&rsquo;s interests <em>primarily</em>. Roads and bridges make it possible for people to get to work to create wealth for others; the same roads and bridges make it easier to move military muscle (<em>e.g.</em>, as the  the Russians are doing in Ukraine).</p>
   <p>Most of us tend to interpret this as, &rdquo;<em>thank goodness, because if it weren't for businesses and the military would not have nice things like bridges, roads, and schools.</em>&rdquo; Sadly, this mindset is literally burning our life boat. It is going to be difficult to understand, to really get, but centralization is not good for us. Centralized power stands in our way of thrivingl. Centralized ownership is hostile to innovation, and creativity, and even hostile to commerce. What innovation there is, (<em>e,g,</em>, pharmaceuticals) is accidental and it overwhelmingly ends up as private goods.</p>
   <p>If you believe, like I do, that democracies (<em>i.e.</em>  decentralized ownership) is better than centralized State control<a id="bm13" href="#en13"><sup>13</sup></a>, then it follows that we sould insist continuing to <em>get away from centralization</em> and <em>move towards decentralization</em>. But that change in mindset is going against everything we &ldquo;know,&rdquo; right?</p>
  </td>
 </tr>
 <tr>
  <td class="_spacer">&nbsp;</td>
