...
<h1>&nbsp;</h1>
 ...
 <div class="_center">
  <img
   ...
   width="70%"
   alt="A horizontal like label 'co-ownership spectrum' show <span class='_paradigm'>Fiat</spam> at the extreme left, RADICAL at the extrem right, and K2K in between.">
 </div>
