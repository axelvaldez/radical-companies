...
<h1>Nearsoft</h1>
 <p>This reminds me of a Nearsoft developer who really wanted somebody, an authority, to give him a title. Nearsoft didn&rsquo;t have a <span class="_paradigm">FIAT</span> hierarchy, so it would have been easy enough to give himself a title. But this person insisted that a title be <em>given</em> to him. Later, talking to him, I found out that he wanted to be acknowledged by <em>Nearsoft</em>. I said something like, <span class="_quotespan">you should have gone to your team them, they are the &ldquo;authority&rdquo; on acknowledgement</span>, and he agreed that they were the &ldquo;authority,&rdquo; not me.</p>
