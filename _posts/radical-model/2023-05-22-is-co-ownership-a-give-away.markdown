...
<h1>FAQ</h1>
 <h2 class="_q">But they end up as owners of my property!<h2>
 <h2 class="_a">
  <p>Yes.</p>
 ...
 <h2 class="_q">What if I want money up front?<h2>
 <h2 class="_a">Your ex-employees, not co-owners, could get a loan from the bank based on the performance of the company. They can then hand that capital to you. It would probably not be the full amount, but significant enough that you&rsquo;d agree to it.</h2>
 <h2 class="_q">But if they run it into the ground?<h2>
 <h2 class="_a">They probably will not, but let&rsquo;s assume they do. In that case you would have put a clause in the agreement to protect you from that situation. <span class="_quotespan">If they revenue goes down by X% of predicted, this agreement will be nulled and void&hellip;</span></h2>
