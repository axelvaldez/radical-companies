...
<h1>Final Notes</h1>
 ...
 <p>The <span class="_paradigm">RADICAL</span> system is an alternative to the <span class="_paradigm">FIAT</span> system. If nothing else, it will make sure that people are not <span class="_quotespan">extremely perplexed,</span> and can think of their own alternatives.
