...
<h1>&nbsp;</h1>
 ...
 <p>The problem is that the <span class="_paradigm">FIAT</span> system is based on competition and domination and capital happens to be a very efficient form tool of domination. Our alternative is have a system based on contribuions, instead of capital: the <span class="_paradigm">RADICAL</span> system, we believe, will produced more of a life nourising system, which .</p>
