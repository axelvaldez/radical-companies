...
<h1>&nbsp;</h1>
 ...
 <p>The obstacle has been to decide what is a contribution. We are so used to the <span class="_paradigm">FIAT</span> hierarchical model that we immediately jump to rules and benevolent judges. But as it always happen benevolent judges don&rsquo;t stay benevolent for a long time and rules always sprout a bureaucracy around them, to &ldquo;adimister&rdquo; them.</p>
