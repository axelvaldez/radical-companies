...
<h1>The Tshirt Said It (almost)</h1>
 ...
 <p>I would change it to,</p>
  ...
  <p>Fiat is <em>bigger</em> than capitalism. Actually Fiat is <em>orthogonal</em> to capitalism.</p>
   ...
   <p>In the 21<sup>th</sup> Century individuals and banks can issue capital as a loan. And like all loans they would have a fixed gain whereas shares are a forever gain.</p>
