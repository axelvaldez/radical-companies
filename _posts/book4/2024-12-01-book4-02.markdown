...
<h1>The Tshirt Said It (Almost)</h1>
 ...
 <p>I would change it to,</p>
  ...
  <p>Fiat is <em>bigger</em> than capitalism. Actually Fiat is <em>orthogonal</em> to capitalism.</p>
   ...
   <p>In the good old days when the Dutch invented capitalism shares of the businesses were given in exchange for capital. In the 21<sup>th</sup> Century even individuals can issue capital as a loan. And like all loans they have a fixed gain, where as <em>shares</em> they are a &lsquo;forever gain.&rsquo;</p>
