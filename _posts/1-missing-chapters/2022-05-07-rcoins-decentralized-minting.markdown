...
<h1 class='_section'>Appendix: FAQ</h1>
 <div class='_center'>
  <table class='_h2table'>
   <tr>
    <th id="VaryingBuyingPower">VARYING BUYING POWER</th>
    <td>
