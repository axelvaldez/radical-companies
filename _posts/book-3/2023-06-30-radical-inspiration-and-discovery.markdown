...
<h1>Scarcity and Abudance</h1>
 <h2>Fiat</h2>
  <p>Food scarcity ended centuries ago, as soon as agriculture started to mix in with hunting and gathering. But then, agriculture brought in land scarcity and the rest is history: we are defined by scarcity. That&rsquo;s how the story goes.</p>
