...
<h1>Scarcity and Abudance</h1>
 <h2>Fiat</h2>
  ...
  <p>Actually, what agriculture brought about was <em>land enclosures.</em> An enclosure is when somebody takes <em>by force</em> over land that was previously communal and provided for all. After the enclosure, if you want to use the land, you have to pay <em>rent.</em></p>
 <h2>Non-Fiat</h2>
  <p></p>
