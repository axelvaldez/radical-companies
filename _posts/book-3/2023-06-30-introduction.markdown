...
<h1>Work and Other Ills</h1>
 <p>If you are feeling a overwhelmed by work, it is not a matter of working harder. That is what your boss tells you and even your well-meaning co-workers. That is what every business book says, <span class='_quotespan'>Search for Excellence,</span> <span class='_quotespan'>The Seven Habits You Need to Move Up,</span> <span class='_quotespan'>Do More with Less Effort.</span> These are all about you doing less than you can. But it is not you. It is the system that we call <span class='_paradigm'>Fiat</span>. The <span class='_paradigm'>Fiat</span> system is designed for you to create more wealth for the owners and investors of the business you work for. Do more (You are not doing enough). Work smarter (you are not working smart enough).</p>
