...
<h1>Capital and Contributions</h1>
 ...
 <h2>Capital</h2>
  ...
  <p>Usually that capital goes to pay for things needed for the company and to fund a <span class='_paradigm'>Predictable Recurrig Income</span> (PRI) fund. The PRI is used to pay co-owners a predictable, recurring amount of money when there is little or no revenue. The PRI is paid back by the revenue each co-owner gets given their <span class='_paradigm'>RAD</span>s. Until it is paid in full, what a co-owner takes of out of the PRI fund is a personal debt.</p>
