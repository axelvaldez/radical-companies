...
<h1>The Book</h1>
 <p>The rest of the book takes it one <span class='_paradigm'>Fiat</span> theme are a time. It then compares how it works in a <span class='_paradigm'>Fiat</span> system and how it would work in a non-<span class='_paradigm'>Fiat</span> system. Because I a describing a system, you may find the book repetitive.</p>
