...
<h1>Countries and Other Divisions</h1>
 ...
 <p>In my community I trust. In my decentralized and fully transparent community I trust. What is going to keep my community growing is what&rsquo;s good for them which is what is good for me. And if it doesn&rsquo;t work for me, I'll find another community.</p>
 <ul>
 ...
 <ul>
  <li>To hold us together a community must define the what for, the Impact, that it wants to have on the world.</li>
  <li>It must be explicit about the why, its Purpose, that made it come togeter as a community.</li>
  <li>The community can then define the what, when, and how, the Mission, of the work it needs to do.</li>
 </ul>
 <p>This is its Explicit Aiignment.</p>
