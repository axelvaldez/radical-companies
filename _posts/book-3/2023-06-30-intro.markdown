...
<h1>Rules, Laws, and Force</h1>
 ...
 <p>---</p>
 <p>In an alternative to the <span class='_paradigm'>Fiat</span> system there is no you-ha-do-it-or-else force. The myth is without <span class='_paradigm'>Fiat</span> and force we would never do anything of significance, we would never do anything bigger than ourselves. As I said, that is a myth.<p>
 <p>First came prisioners of minor wars. They were made to carry whatever the winners didn&rsquo;t want to carry.
