...
<h1>Rules, Laws, and Force</h1>
 <p>Rules, followed by convention, eventually turn into laws which <em>you are <em>forced</em> to follow,</em></p>
  <ul>
   ...
   <li>If you feel that is an injustice, you let it go to court (<em>i.e.</em>, another type of force).</p>
   <p>If they rule in your behalf, you celebrate; if they don&rsquo;t, you are angry but you have to pay the ticket. Still minor force.</li>
   <li>If you happen to be from the edge, it may get ugly. It may end up in prison time for you. No longer a minor force.</li>
   <li>In prison you end in a fight and you end up maimed or dead or you kill or maimed somebody. Definitely a <em>force majeure</em>.</li>
  </ul>
 <p>Force is ever present in out <span class='_paradigm'>Fiat</span> system.</p>
