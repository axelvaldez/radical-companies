        ...
        <p>All members are co-owners of the community. If their goal is to build products or services it would be called a company, which is different from a business,</p>
         <ul>
          ...
          <li>
           ...
           <p>BTW, the word company comes from the Latin prefix <em>co</em>, meaning <em>together</em>, and the Latin word <em>pan</em>, meaning <em>bread</em>: breaking bread together.</p>
          </li>
