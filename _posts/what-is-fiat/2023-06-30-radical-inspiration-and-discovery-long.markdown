  ...
  <p>For subsequent co-owner candidates, any co-owner can go through the Explicit Relationship with them and consistently communicate what the community is about.</p>
   ...
   <div class='_center'>
    <table class='_explicitalignment'>
     ...
     <tr>
      <th>What? When? How?</th>
      <td>Here is where the projects are listed. There may be a single one or many of these going on at one time. This is not your traditional Gantt chart, rather each is an experiment. The <em>what</em> is the expected results (<eg>i.e.</eg>, the hypotheses), the <em>when</em> is an estimate, and the <em>how</em> is optional. If you are not really sure of your approach, you should state the <em>how</em> so others can help you.</td>
     </tr>
    </table>
