...
<h1>The Fiat System</h1>
 <p>We live in a <span class='_paradigm'>Fiat</span> environment, or more accurately, a <span class='_paradigm'>Fiat</span> <em>system</em>.</span> Some people <em>do not</em> like the word <em>system</em> associated with their lives, and that is understandable. <span class='_quotespan'>My life is not limited by a system, I shape it however I want to.</span> However, you and I live within a system that has been evolving for quite a while.</p>
