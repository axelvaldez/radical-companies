...
<h1>Scarcity and Abundance</h1>
 <h2>Fiat</h2>
  ...
  <p>Actually, what agriculture brought about was <em>land enclosures.</em> An enclosure is when somebody takes, <em>by force</em>, over land that was previously communal and provided for all. After the enclosure, if you want to use the land, you have to render goods.<a href='#en05'><sup id='bm05'>&hairsp;&nabla;&hairsp;</sup></a> Abundance for a few, scarcity for everybody else.</p>
