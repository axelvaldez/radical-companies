...
<h1>The Fiat System</h1>
 ...
 <p>We created the system and we maintain it. You have a boss, within the <span class='_paradigm'>Fiat</span> system. And within the <span class='_paradigm'>Fiat</span> system, you work for a wage and you produce wealth for the owner of the business you work for, not for yourself. These are a elements of the <span class='_paradigm'>Fiat</span> system that we created, we live in, and we uphold.</p>
